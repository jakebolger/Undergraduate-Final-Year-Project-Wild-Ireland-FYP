...
public class SquirrelQuizManager : MonoBehaviour
{
    ...
    private Question[] _questions1 = null;
    public Question[] Questions { get { return _questions1; } }
    ...
    void LoadQuestions()
    {
        Object[] objs = Resources.LoadAll("QuestionsSquirrel", typeof(Question));
        _questions1 = new Question[objs.Length];
        for (int i = 0; i < objs.Length; i++)
        {
            _questions1[i] = (Question)objs[i];
        }
    }
